  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-6 px-4 py-16 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
        RigorUp for Students
      </h1>
      <p className="max-w-2xl text-sm leading-relaxed text-muted sm:text-base">
        Turn overwhelm into clarity with personal learning journeys, weekly
        goals, and real-time feedback that help you move from guessing to
        confident progress.
      </p>
      <div className="flex flex-wrap gap-4">
        <Link
          ...
          aria-label="Get a demo of RigorUp for students"
        >
          Get Demo
        </Link>
        <Link
