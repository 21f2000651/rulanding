...
const studentFaqs = [
  {
    ...
    answer:
      "Most schools are ready to launch in 2–4 weeks. We support onboarding for leadership, teachers, and students with a guided setup plan and milestone check-ins.",
  },
  {
    question: "Will teachers need to change their existing workflow?",
    answer:
      "No complete reset is required. RigorUp integrates with everyday classroom routines and automates repetitive tasks so teachers can focus on instruction.",
  },
  {
    question: "Can students get truly personalized practice plans?",
    answer:
      "Yes. Each learner receives adaptive practice routes based on concept mastery, pace, and confidence so learning stays clear and structured week by week.",
  },
  {
    question: "What does school leadership receive in the dashboard?",
    answer:
      "Leadership gets cohort trends, risk alerts, class-level drill downs, and intervention visibility to make faster, data-backed academic decisions.",
  },
  {
    question: "How does RigorUp support parents and communication?",
    answer:
      "RigorUp creates clear progress snapshots and actionable next steps, helping parent conversations stay proactive and aligned.",
  },
];
    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col px-4 pb-16 pt-8 sm:px-6 md:pb-20 lg:px-8">
      ...
      >
        ...
        >
          ...
          >
            AI-Powered Smart
            <span className="block text-primary">Personalized Learning</span>
          </h1>
          <p className="mx-auto max-w-2xl text-sm leading-relaxed text-muted sm:text-[15px]">
            ...
            Platform built for Unlocking Academic Excellence.
          </p>
        </motion.div>
        ...
        <button
          ...
          aria-label="Get demo for student platform"
        >
        ...
        >
          <div className="overflow-hidden rounded-[1.35rem] border border-primary/10 bg-white p-4 sm:p-6">
            <div className="relative mx-auto aspect-[16/10] w-full max-w-[790px] rounded-2xl bg-[radial-gradient(circle_at_top_right,rgba(108,89,252,0.14),transparent_60%)]">
              <Image
                src="/Student Dashboard.png"
                alt="Student dashboard preview showing welcome panel, analytics, assignments, and activity calendar"
                fill
                className="object-contain"
                sizes="(min-width: 1280px) 790px, (min-width: 768px) 85vw, 95vw"
                priority
              />
            </div>
          </div>
      ...
      <section
        aria-labelledby="student-help-heading"
      ...
      >
        <div className="space-y-2 text-center">
          ...
          >
            What all <span className="text-primary">RigorUp helps in?</span>
          </h2>
          <p className="text-sm text-muted sm:text-[15px]">
            All you need to excel in academics under one hood.
          </p>
        </div>

        <div className="grid gap-4 md:grid-cols-3">
          {studentPillars.map((title) => (
            <motion.article
              key={title}
      ...
      >
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted sm:text-[15px]">
            Quick answers for school leaders, teachers, and students evaluating
            the platform.
          </p>
        </div>
            ...
            return (
              ...
              >
                <button
                  ...
                  aria-controls={`student-faq-panel-${index}`}
      ...
      <section id="get-demo" className="py-12 md:py-16">
        ...
        >
          <h2 className="text-2xl font-semibold tracking-tight sm:text-[2rem]">
            Ready to Accelerate your academic Excellence?
          </h2>
          <button
            type="button"
